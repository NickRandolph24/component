...
I will be using a linked list to add different song names and store different songs.
I will also use a queue so that A first in first out and a last in last out function can be added.
...
- Designed kernel implementation for Kernel Implementation component
